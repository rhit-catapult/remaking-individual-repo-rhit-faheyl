...
class Missile:
    ...
    def draw(self):
        ...
        pygame.draw.line(self.screen, (255, 0, 0), (self.x, self.y), (self.x, self.y + 8))
...
class Fighter:
    ...
    def move(self, move_amount_x):
        ...
        right_bound = 0 + self.image.get_width() / 2
        pass
    def draw(self):
    ...
    def fire(self):
        ...
        new_missile = Missile(self.screen, (self.image.get_width()//2, self.y))
