...
def main():
    ...
    font1 = pygame.font.SysFont("Roboto", 28)
    font2 = pygame.font.SysFont("comicsansms", 40)
    # TODO 5: Render the text "Two Dogs" using the font object (it's like MAKING an image).
    caption1 = font1.render("Two Dawgs", True, BLACK)
    caption2 = font2.render("im evil dog >:)", True, RED)
    # Prepare the music
    ...
    while True:
        ...
        screen.blit(caption1, (170, 475))
        screen.blit(caption2, (220, 10))
