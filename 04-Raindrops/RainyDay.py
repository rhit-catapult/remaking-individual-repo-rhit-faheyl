...
class Raindrop:
    def __init__(self, screen, x, y):
        ...
        self.x = x
        self.y = y
        self.color = (0 + random.randint(0, 255), 0 + random.randint(0, 255), 0 + random.randint(0, 255))
        self.width = (1 + random.randint(0, 6))
        self.speed = random.randint(20, 30) / self.width
    def move(self):
    ...
    def draw(self):
        ...
        pygame.draw.line(self.screen, self.color, (self.x, self.y), (self.x, self.y + 5), self.width)
...
class Hero:
    def __init__(self, screen, x, y, with_umbrella_filename, without_umbrella_filename):
        ...
        self.x = x
        self.y = y
        self.image_with_umbrella_filename = pygame.image.load(with_umbrella_filename)
        self.image_without_umbrella_filename = pygame.image.load(without_umbrella_filename)
        self.last_hit_time = 0

    def draw(self):
        """ Draws this sprite onto the screen. """
        # TODO 17: Draw (blit) this Hero, at this Hero's position, WITHOUT an umbrella:
        self.screen.blit(self.image_without_umbrella_filename, (self.x, self.y))
...
def main():
    ...
    test_raindrop = Raindrop(screen, 650, 10)
    mike = Hero(screen, 300, 600, "mike_umbrella.png", "mike.png")
    alyssa = Hero(screen, 600, 600, "alyssa_umbrella.png", "alyssa.png")
